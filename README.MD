...
## Installation & Setup (For docker skip to next step)
...
│   └── urls.py
├── .gitignore
└── .Dockerfile               # Docker file to create image and container for deployment
└── .dockerignore            # files docker need to ignore
└── manage.py
```
...
https://studdybuddy-np1y.onrender.com/
---
